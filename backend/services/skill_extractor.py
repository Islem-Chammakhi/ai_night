...
def extract_skills_from_text(text: str) -> list[str]:
    ...
    certifications, and soft skills from the following text.
    ...
    try:
        ...
        # Clean in case model adds markdown
...
def compute_skill_score(cv_skills: list[str], required_skills: list[str]) -> tuple[float, list[str], list[str]]:
    ...
    for req_skill in required_skills:
        ...
        # Check exact match or if skill is contained in any cv skill
        found = any(
